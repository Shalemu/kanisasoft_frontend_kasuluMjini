              ...
              <div className="p-6 flex flex-col h-full">
                ...
                <div className="mt-5 pt-4 border-t border-slate-100">
                  <button
                    ...
                    className="w-full py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium transition-all duration-300"
                  >
                    Angalia Maelezo
                  </button>
                </div>
              ...
              <div className="p-6 md:p-8 max-h-[85vh] overflow-y-auto">
                ...
                <div className="flex justify-between items-start gap-4 mb-6">
                  <div>
                    ...
                    <p className="text-sm text-slate-400 mt-1">Tukio lililopita</p>
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                  ...
                  {selectedEvent.location && (
                    <div className="flex items-center gap-3 bg-slate-50 rounded-xl px-4 py-3 text-slate-700 sm:col-span-2">
                      <FaMapMarkerAlt className="text-emerald-500" />
