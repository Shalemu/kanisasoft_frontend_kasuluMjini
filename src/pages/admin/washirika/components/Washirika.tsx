        ...
        const smsResponse = await apiFetch('/send-sms', {
          ...
          body: JSON.stringify({
            ...
            name: member.full_name,
             message: `Bwana Yesu asifiwe ${member.full_name}, Sasa wewe ni mshirika rasmi wa FPCT KASULU MJINI  Namba yako ya ushirika ni:  ${response.member.membership_number}`,
