...
export default function RipotiTab() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10 space-y-10 bg-gradient-to-br from-[#f0f4ff] to-white min-h-screen">
      {/* Header */}
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
        <h2 className="text-3xl font-bold text-sky-800 flex items-center gap-2">
          📈 Ripoti za Matukio
        </h2>
        <select
          value={range}
          onChange={(e) => setRange(e.target.value as RangeOption)}
          className="px-4 py-2 rounded-xl border text-sm bg-white text-gray-700 shadow focus:ring-2 focus:ring-sky-400"
        >
